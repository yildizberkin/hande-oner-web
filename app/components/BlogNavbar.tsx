...
export default function BlogNavbar({ language }: BlogNavbarProps) {
  ...
  const home = isTr ? "/" : "/en";
  const blog = isTr ? "/blog" : "/en/blog";
  const otherBlog = isTr ? "/en/blog" : "/blog";
    ...
    <>
      <header className="cms-blog-navbar section-shell">
        ...
        <nav
          ...
          aria-label={isTr ? "Blog navigasyonu" : "Blog navigation"}
        >
          {links.map((link) => (
            <a
              key={link.href}
        ...
        <button
          ...
          aria-controls="cms-blog-mobile-menu"
